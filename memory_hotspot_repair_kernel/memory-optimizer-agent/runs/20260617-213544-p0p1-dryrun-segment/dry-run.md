...
'@ | python -
`
- `smoke_segment_level_scoring` (auto, timeout=180s): `python src/segment_causal_pipeline_v2/segment_level_recommendation_scoring.py --config src/segment_causal_pipeline_v2/tmp_smoke/segment_level_recommendation_scoring_smoke.yaml
`
- `smoke_recommendation_scoring` (auto, timeout=180s): `python src/segment_causal_pipeline_v2/recommendation_scoring.py --config src/segment_causal_pipeline_v2/tmp_smoke/recommendation_scoring_smoke.yaml
`