...
OVERLAY_REGISTRY: tuple[dict[str, Any], ...] = (
    {
        "match_prefixes": ("src/segment_causal_pipeline_v2",),
        "check_overlay": SKILLS_REVIEW_DIR / "memory-check" / "references" / "overlays" / "segment-causal-pipeline-v2.md",
        "fix_overlay": SKILLS_REVIEW_DIR / "memory-fix" / "references" / "overlays" / "segment-causal-pipeline-v2.md",
        "review_overlay": SKILLS_REVIEW_DIR / "memory-review" / "references" / "overlays" / "segment-causal-pipeline-v2.md",
    },
)
